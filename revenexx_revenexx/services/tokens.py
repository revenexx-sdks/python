...
class Tokens(Service):
    ...
    def tokens_list(
        ...
        api_path = '/v1/tokens/buckets/{bucketId}/files/{fileId}'
        api_params = {}
        if bucket_id is None:
            raise RevenexxAPIRevenexxException('Missing required parameter: "bucket_id"')

        if file_id is None:
            raise RevenexxAPIRevenexxException('Missing required parameter: "file_id"')
    ...
    def tokens_delete(
        ...
        api_path = '/v1/tokens/{tokenId}'
        api_params = {}
        if token_id is None:
            raise RevenexxAPIRevenexxException('Missing required parameter: "token_id"')
