...
class AddressTypeRowUpdateRequest(AppwriteModel):
    """
    ...
    tone : Optional[AddressTypeRowUpdateRequestTone]
    ...
    tone: Optional[AddressTypeRowUpdateRequestTone] = Field(default=None, alias='tone')
