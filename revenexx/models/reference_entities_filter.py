...
class ReferenceEntitiesFilter(AppwriteModel, Generic[T]):
    """
    ...
    @classmethod
    def with_data(cls, data: Dict[str, Any], model_type: Type[T] = dict) -> 'ReferenceEntitiesFilter[T]':
        """Create ReferenceEntitiesFilter instance with typed data."""
