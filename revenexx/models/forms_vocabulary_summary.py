...
class FormsVocabularySummary(AppwriteModel):
    """
    ...
    name : Optional[FormsVocabularySummaryName]
    ...
    name: Optional[FormsVocabularySummaryName] = Field(default=None, alias='name')
