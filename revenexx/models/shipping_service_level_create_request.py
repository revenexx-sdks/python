...
class ShippingServiceLevelCreateRequest(AppwriteModel):
    """
    ...
    tone : Optional[ShippingServiceLevelCreateRequestTone]
    ...
    tone: Optional[ShippingServiceLevelCreateRequestTone] = Field(default=None, alias='tone')
