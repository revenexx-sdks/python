...
class ProductCategoriesFilter(AppwriteModel, Generic[T]):
    """
    ...
    @classmethod
    def with_data(cls, data: Dict[str, Any], model_type: Type[T] = dict) -> 'ProductCategoriesFilter[T]':
        """Create ProductCategoriesFilter instance with typed data."""
