...
class AuthMfaChallengeConfirmResponse(AppwriteModel, Generic[T]):
    """
    ...
    @classmethod
    def with_data(cls, data: Dict[str, Any], model_type: Type[T] = dict) -> 'AuthMfaChallengeConfirmResponse[T]':
        """Create AuthMfaChallengeConfirmResponse instance with typed data."""
