...
class ContactCreateRequest(AppwriteModel):
    ...
    registration_status : Optional[ContactCreateRequestRegistrationStatus]
    ...
    registration_status: Optional[ContactCreateRequestRegistrationStatus] = Field(default=None, alias='registration_status')
