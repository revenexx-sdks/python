...
class StockMovementsFilter(AppwriteModel, Generic[T]):
    """
    ...
    @classmethod
    def with_data(cls, data: Dict[str, Any], model_type: Type[T] = dict) -> 'StockMovementsFilter[T]':
        """Create StockMovementsFilter instance with typed data."""
