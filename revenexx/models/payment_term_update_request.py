...
class PaymentTermUpdateRequest(AppwriteModel):
    """
    ...
    tone : Optional[PaymentTermUpdateRequestTone]
    ...
    tone: Optional[PaymentTermUpdateRequestTone] = Field(default=None, alias='tone')
