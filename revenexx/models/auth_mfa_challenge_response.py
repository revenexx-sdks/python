...
class AuthMfaChallengeResponse(AppwriteModel, Generic[T]):
    """
    ...
    @classmethod
    def with_data(cls, data: Dict[str, Any], model_type: Type[T] = dict) -> 'AuthMfaChallengeResponse[T]':
        """Create AuthMfaChallengeResponse instance with typed data."""
