...
class FormListFilter(AppwriteModel, Generic[T]):
    """
    ...
    @classmethod
    def with_data(cls, data: Dict[str, Any], model_type: Type[T] = dict) -> 'FormListFilter[T]':
        """Create FormListFilter instance with typed data."""
