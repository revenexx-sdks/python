...
class CategoriesFilter(AppwriteModel, Generic[T]):
    """
    ...
    @classmethod
    def with_data(cls, data: Dict[str, Any], model_type: Type[T] = dict) -> 'CategoriesFilter[T]':
        """Create CategoriesFilter instance with typed data."""
