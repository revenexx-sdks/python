...
class MarketReadinessReport(AppwriteModel):
    """
    ...
    Attributes
    ----------
    blocking : Optional[List[MarketReadinessReportBlocking]]
    ...
    counts : Optional[MarketReadinessCounts]
    ...
    market : Optional[MarketReadinessSubject]
    ...
    warnings : Optional[List[MarketReadinessReportWarnings]]
    ...
    """
    blocking: Optional[List[MarketReadinessReportBlocking]] = Field(default=None, alias='blocking')
    checks: Optional[List[MarketReadinessCheck]] = Field(default=None, alias='checks')
    counts: Optional[MarketReadinessCounts] = Field(default=None, alias='counts')
    market: Optional[MarketReadinessSubject] = Field(default=None, alias='market')
    ready: Optional[bool] = Field(default=None, alias='ready')
    serving: Optional[bool] = Field(default=None, alias='serving')
    warnings: Optional[List[MarketReadinessReportWarnings]] = Field(default=None, alias='warnings')
