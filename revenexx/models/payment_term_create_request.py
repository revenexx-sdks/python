...
class PaymentTermCreateRequest(AppwriteModel):
    """
    ...
    tone : Optional[PaymentTermCreateRequestTone]
    ...
    tone: Optional[PaymentTermCreateRequestTone] = Field(default=None, alias='tone')
