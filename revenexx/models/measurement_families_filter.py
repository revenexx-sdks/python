...
class MeasurementFamiliesFilter(AppwriteModel, Generic[T]):
    """
    ...
    @classmethod
    def with_data(cls, data: Dict[str, Any], model_type: Type[T] = dict) -> 'MeasurementFamiliesFilter[T]':
        """Create MeasurementFamiliesFilter instance with typed data."""
