...
class AuthOtpResponse(AppwriteModel, Generic[T]):
    """
    ...
    @classmethod
    def with_data(cls, data: Dict[str, Any], model_type: Type[T] = dict) -> 'AuthOtpResponse[T]':
        """Create AuthOtpResponse instance with typed data."""
