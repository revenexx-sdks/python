...
class AttributeGroupsFilter(AppwriteModel, Generic[T]):
    """
    ...
    @classmethod
    def with_data(cls, data: Dict[str, Any], model_type: Type[T] = dict) -> 'AttributeGroupsFilter[T]':
        """Create AttributeGroupsFilter instance with typed data."""
