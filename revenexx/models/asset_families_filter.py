...
class AssetFamiliesFilter(AppwriteModel, Generic[T]):
    """
    ...
    naming_convention: Optional[str] = Field(default=None, alias='naming_convention')
    updated_at: Optional[str] = Field(default=None, alias='updated_at')

    @classmethod
    def with_data(cls, data: Dict[str, Any], model_type: Type[T] = dict) -> 'AssetFamiliesFilter[T]':
        """Create AssetFamiliesFilter instance with typed data."""
