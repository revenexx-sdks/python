...
class CartItemUpdateRequest(AppwriteModel, Generic[T]):
    """
    ...
    @classmethod
    def with_data(cls, data: Dict[str, Any], model_type: Type[T] = dict) -> 'CartItemUpdateRequest[T]':
        """Create CartItemUpdateRequest instance with typed data."""
