...
class LocationsFilter(AppwriteModel, Generic[T]):
    """
    ...
    @classmethod
    def with_data(cls, data: Dict[str, Any], model_type: Type[T] = dict) -> 'LocationsFilter[T]':
        """Create LocationsFilter instance with typed data."""
