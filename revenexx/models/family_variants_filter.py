...
class FamilyVariantsFilter(AppwriteModel, Generic[T]):
    """
    ...
    """
    axes: Optional[str] = Field(default=None, alias='axes')
    ...
    @classmethod
    def with_data(cls, data: Dict[str, Any], model_type: Type[T] = dict) -> 'FamilyVariantsFilter[T]':
        """Create FamilyVariantsFilter instance with typed data."""
