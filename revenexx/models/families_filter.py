...
class FamiliesFilter(AppwriteModel, Generic[T]):
    """
    ...
    @classmethod
    def with_data(cls, data: Dict[str, Any], model_type: Type[T] = dict) -> 'FamiliesFilter[T]':
        """Create FamiliesFilter instance with typed data."""
