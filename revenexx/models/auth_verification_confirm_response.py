...
class AuthVerificationConfirmResponse(AppwriteModel, Generic[T]):
    """
    ...
    @classmethod
    def with_data(cls, data: Dict[str, Any], model_type: Type[T] = dict) -> 'AuthVerificationConfirmResponse[T]':
        """Create AuthVerificationConfirmResponse instance with typed data."""
