...
class MultiSearchEntry(AppwriteModel, Generic[T]):
    """
    ...
    @classmethod
    def with_data(cls, data: Dict[str, Any], model_type: Type[T] = dict) -> 'MultiSearchEntry[T]':
        """Create MultiSearchEntry instance with typed data."""
