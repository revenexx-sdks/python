...
class Avatars(Service):
    ...
    def avatars_get_qr(
        ...
        api_params = {}
        if text is None:
            raise RevenexxException('Missing required parameter: "text"')
    ...
    def avatars_get_screenshot(
        ...
        timezone : Optional[Timezone]
            IANA timezone identifier, canonically cased (e.g. `America/New_York`, `Europe/London`). Defaults to the browser default. Only two-segment identifiers are accepted: `UTC` and the three-segment ids such as `America/Argentina/Buenos_Aires` are refused with 404.
        ...
        api_path = '/v1/avatars/screenshots'
        api_params = {}
        if url is None:
            raise RevenexxException('Missing required parameter: "url"')
