...
class Apps(Service):
    ...
    def apps_create(
        ...
        if function_id is None:
            raise RevenexxException('Missing required parameter: "function_id"')

        if name is None:
            raise RevenexxException('Missing required parameter: "name"')

        if runtime is None:
            raise RevenexxException('Missing required parameter: "runtime"')
    ...
    def apps_create_vcs_deployment(
        ...
        function_id: str,
        reference: str,
        type: AppsCreateVcsDeploymentType,
        activate: Optional[bool] = None
    ) -> Deployment:
        """
    ...
    def apps_delete_execution(
        ...
        if execution_id is None:
            raise RevenexxException('Missing required parameter: "execution_id"')
